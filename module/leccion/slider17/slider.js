export function init() {
    ...
    // Inicializar con el orden específico: 5, 3, 4, 6, 1, 2
    const initialOrder = [
        "horizontales_sld18", // 5
        "semaforos_sld18",    // 3
        "verticales_sld18",   // 4
        "liberacion_seguros_sld18", // 6
    ...
    function initMobileView() {
        ...
        // Crear elementos móviles en el orden específico: 5, 3, 4, 6, 1, 2
        const mobileOrder = [
            "horizontales_sld18", // 5
            "semaforos_sld18",    // 3
            "verticales_sld18",   // 4
        ...
        if (isMobile) {
            ...
            items.forEach(item => {
                ...
                if (mobileItem) {
                    ...
                    if (isCorrect) {
                        iconDiv.classList.add('correct');
                        iconDiv.innerHTML = '<i class="fa fa-check"></i>';
                    } else {
                        iconDiv.classList.add('incorrect');
                        iconDiv.innerHTML = '<i class="fa fa-times"></i>';
                    }
        ...
        if (correctCount === totalCount) {
            validationMessage.innerHTML = `
                <p class="validation-text-dadarrast">
                    <strong>¡Muy bien! ¡Has ordenado correctamente el procedimiento de bloqueo y etiquetado (LOTO)!</strong>
                </p>
    ...
    function handleReset() {
        ...
        if (isMobile) {
            ...
            // Restablecer el orden inicial específico: 5, 3, 4, 6, 1, 2
            const initialOrder = [
                "horizontales_sld18", // 5
                "semaforos_sld18",    // 3
                "verticales_sld18",   // 4
